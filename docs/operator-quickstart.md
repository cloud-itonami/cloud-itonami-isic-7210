# Operator Quickstart — Research and experimental development on natural sciences and engineering

Shortest path from clone to a verified local dry-run for **ISIC 7210** (`cloud-itonami-isic-7210`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7210.git
cd cloud-itonami-isic-7210
```
...
- Blueprint governor key: `research-integrity-governor`
- Likely source path: `research.governor.cljc`
